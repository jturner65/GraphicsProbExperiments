...
public abstract class myDrawnObject {
	...
	public myDrawnObject(GraphProbExpMain _pa, myVector _canvNorm) {
		pa = _pa;
...
class myVariStroke extends myDrawnObject {
	...
	public myVariStroke(GraphProbExpMain _pa, myVector _canvNorm, int fillClrCnst, int strkClrCnst) {
		super(_pa, _canvNorm);
...
class cntlPt extends myPoint {
	...
	public cntlPt(GraphProbExpMain _pa, myPoint _p, float _r, float _w){ super(_p.x,_p.y, _p.z); pa=_pa; ID=IDincr++;r=_r; w=_w; }
	public cntlPt(GraphProbExpMain _pa, myPoint _p, float _w){this(_pa, _p, baseRad, _w);}
	public cntlPt(GraphProbExpMain _pa, myPoint _p){this(_pa, _p, baseRad, baseRad);}
	public cntlPt(GraphProbExpMain _pa){this(_pa, _pa.P(),1);}
...
abstract class myOffset {
	...
	public myOffset(GraphProbExpMain _pa, boolean _ec){
		pa = _pa;
		ID = IDcnt++;
		endCaps = _ec;
	}	
	
	public myOffset(GraphProbExpMain _pa){this(_pa, true);}
...
class myNormOffset extends myOffset{
	myNormOffset(GraphProbExpMain _pa){super(_pa); name = "Normal offset";}
